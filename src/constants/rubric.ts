...
export const RUBRIC_ITEMS: readonly RubricItem[] = [
  {
    ...
    checkpoints: [
      'ชื่อเรื่อง คำอธิบาย วิชา ระดับชั้น จุดประสงค์ ประเภทสื่อ ครบทุกช่อง',
  ...
  },
  {
    ...
    aiRole: 'FLAGS',
    description:
      'ข้อที่สำคัญที่สุด อาจารย์คนอื่นที่ไม่เคยคุยกับเจ้าของต้องเปิดไฟล์แล้วสอนได้เลย',
    checkpoints: [
  ...
  },
  {
    ...
    level: 'BLOCKING',
    aiRole: 'CHECKS',
    description: 'ไม่มีข้อมูลที่ระบุตัวนักเรียนได้ปรากฏในไฟล์ ถ้าขึ้นธงข้อนี้ต้องให้คนตรวจซ้ำทุกครั้ง',
    checkpoints: [
