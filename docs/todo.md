...
- [ ] `POST /api/review/[id]/topics` บันทึกผลตรวจและคอมเมนต์รายหัวข้อ
...
- [ ] ต้องกันไม่ให้ AI สรุปผ่าน/ไม่ผ่านหรือเปลี่ยนสถานะ มนุษย์เป็นผู้ตัดสินเสมอ

## 7. ยังไม่มีเลย

- [ ] **ไม่มีเทสต์สักตัว** — `assertTransition()` กับตาราง `TRANSITIONS` 12 เส้นทางคือหัวใจของระบบ
