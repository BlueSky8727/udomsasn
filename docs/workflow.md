...
| `ADMIN` | หัวหน้าวิชาการ กำหนดบทบาท/กลุ่มสาระ ตรวจขั้นสุดท้าย อนุมัติ หรือส่งกลับแก้ไขเล็กน้อย |

หัวหน้าวิชาการเป็นผู้เดียวที่เปลี่ยน `profiles.role` และ `profiles.department_id` ได้
...
- `ADMIN` อ่านคิว `ACADEMIC_REVIEW` และเป็นผู้เดียวที่เปลี่ยนบทบาทหรือกลุ่มสาระได้
